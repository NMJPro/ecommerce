                ...
                <div class="navbar-nav w-100 overflow-hidden" style="height: 150px">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                            <a href="{{ route('categoryLevel1')}}" class="dropdown-item">Categorie 1</a>
                            <a href="{{ route('categoryLevel2')}}" class="dropdown-item">Categorie 2</a>
                            <a href="{{ route('categoryLevel3')}}" class="dropdown-item">Categorie 3</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="carousel-item " style="height: 410px;">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <a href="{{ route('shop')}}" class="btn btn-light py-2 px-3"></a>
                            </div>
                        </div>
                    </div>
                </div>
