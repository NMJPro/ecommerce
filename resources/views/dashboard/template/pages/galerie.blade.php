...
@section('js')
  ...
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="../dashboard/plugins/ekko-lightbox/ekko-lightbox.css">
  <!-- Theme style -->
...
<!-- Ekko Lightbox -->
<script src="../dashboard/plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
<!-- AdminLTE App -->
<script src="../dashboard/dist/js/adminlte.min.js"></script>
<!-- Filterizr-->
<script src="../dashboard/plugins/filterizr/jquery.filterizr.min.js"></script>
