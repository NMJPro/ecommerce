...
<body>
    ...
    @include('vitrines.partials.navbarShop')
    @include('vitrines.partials.detailHeader')
    @include('vitrines.partials.shopDetail')
    @include('vitrines.partials.detailProducts')
